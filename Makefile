...
help:
	...
	@echo "  make test PATTERN=base                  # Match test/**/*base*_spec.lua"
	@echo "  make test PATTERN=test/logger_spec.lua   # Full path"
...
# Examples:
#   make test PATTERN=test/logger_spec.lua
#   make test PATTERN=base  (shorthand for test/**/*base*_spec.lua)
test: install-deps
...
clean:
	...
	@rm -rf test/*.out
	@rm -rf *.swp
	@rm -rf /tmp/logger_nvim_test_* 2>/dev/null || true
